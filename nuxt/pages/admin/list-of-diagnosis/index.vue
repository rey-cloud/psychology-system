        ...
        <table class="w-full border-collapse border border-gray-300">
          <thead class="bg-[#92999e]">
            <tr>
              ...
              <th class="p-2 border">Diagnosis ID</th>
          ...
          <tbody>
            <tr v-for="(diagnosisItem, index) in state.diagnosisList" :key="index">
              ...
              <td class="p-2 border align-middle">D-00{{ diagnosisItem.id }}</td>
              ...
              <td class="p-2 border align-middle">
                <div class="flex justify-center gap-5">
                  <NuxtLink :to="`/admin/list-of-diagnosis/${diagnosisItem.id}`"
                  ...
                  <button type="button" @click="() => deleteDiagnosis(diagnosisItem.id)"
