  ...
  <div class="lg:h-screen h-auto w-full bg-[#d1d3d6] tracking-wide text-white absolute">
    <nav class="">
      <section class="justify-between px-20 flex h-32 w-full bg-[#2c3840] shadow-lg fixed top-0 z-50">
        <div class="flex">
          <nuxt-link to="/admin" class="m-auto hover:scale-110 duration-300 ease-in-out">
            <img class="w-auto h-16 mr-3" src="/assets/img/admin/admin-logo.png" alt="admin">
          </nuxt-link>
          <p class="m-auto">Welcome, Admin!</p>
        </div>
        <div class="flex">
    ...
    <section class="mt-52 px-20 mb-16">
