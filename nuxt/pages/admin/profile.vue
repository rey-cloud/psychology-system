...
<div class="bg-[#e4e4e4] h-screen w-full absolute top-0">
  <div class="relative lg:px-20 px-5 mb-20 text-white tracking-wide mt-20">
    ...
    <div class="h-auto w-full bg-[#71797f] rounded-md p-5 shadow-md">
      <div class="grid grid-cols-2 gap-5">
        <section class="p-5 h-auto w-full rounded-lg bg-[#616a70]">
          ...
          <img class="w-auto h-52 m-auto" src="/assets/img/admin/logo.png" alt="admin-img">
        <section class="mt-5 rounded-md p-5 tracking-wider font-semibold bg-[#82898e]">
