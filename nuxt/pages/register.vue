          ...
          <section class="">
            <section class="mb-3">
              ...
              <section class="flex lg:gap-0 gap-2 justify-between mt-1">
                <div class="w-full lg:mr-5 mr-0mr-5">
                  ...
                  <input
                    ...
                    :class="{ 'border-red-500': state.errors && state.errors._data && state.errors._data.errors && state.errors._data.errors.first_name }"
                  ...
                  <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                    state.errors._data.errors && state.errors._data.errors.first_name &&
                    state.errors._data.errors.first_name[0] }}</div>
                </div>
                <div class="w-full lg:mr-5 mr-0">
                  <h4 class="text-sm text-gray-400">Last Name</h4>
                  <input
                    class="w-full bg-white py-2 px-3 rounded-md border-2 border-gray-300 outline-none focus:border-[#003568] focus:text-[#004e94]"
                    :class="{ 'border-red-500': state.errors && state.errors._data && state.errors._data.errors && state.errors._data.errors.last_name }"
                    type="text" v-model="state.user.last_name" placeholder="*" />
                  <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                    state.errors._data.errors && state.errors._data.errors.last_name &&
                    state.errors._data.errors.last_name[0] }}</div>
                </div>
                <div class="w-1/2">
                  <h4 class="text-sm text-gray-400">M. I. (Opt.)</h4>
                  <input
                    class="w-full bg-white py-2 px-3 rounded-md border-2 border-gray-300 outline-none focus:border-[#003568] focus:text-[#004e94]"
                    :class="{ 'border-red-500': state.errors && state.errors._data && state.errors._data.errors && state.errors._data.errors.middle_initial }"
                    v-model="state.user.middle_initial" type="text" />
                  <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                    state.errors._data.errors && state.errors._data.errors.middle_initial &&
                    state.errors._data.errors.middle_initial[0] }}</div>
                </div>
              </section>
            </section>
            ...
            <section class="mb-3 flex lg:gap-0 gap-3 justify-between">
              <div>
                ...
                <input
                  ...
                  :class="{ 'border-red-500': state.errors && state.errors._data && state.errors._data.errors && state.errors._data.errors.birth_date }"
                  type="text" v-model="state.user.birth_date" placeholder="*" />
                <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  state.errors._data.errors && state.errors._data.errors.birth_date &&
                  state.errors._data.errors.birth_date[0] }}</div>
              </div>
              <div class="lg:w-full w-auto lg:ml-4 ml-0">
                <div class="lg:flex block duration-300">
                ...
                <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  state.errors._data.errors && state.errors._data.errors.gender &&
                  state.errors._data.errors.gender[0] }}</div>
              </div>
            </section>
              ...
              <div>
                <div class="flex duration-300">
                  ...
                  <div class="flex">
                    ...
                    <p class="text-sm text-gray-400 m-auto ml-1">(0919..)</p>
                  </div>
                </div>
                <input
                  class="lg:w-[340px] w-full bg-white py-2 px-3 rounded-md border-2 border-gray-300 outline-none focus:border-[#003568] focus:text-[#004e94] mt-1"
                  :class="{ 'border-red-500': state.errors && state.errors._data && state.errors._data.errors && state.errors._data.errors.phone }"
                  type="text" v-model="state.user.phone" />
                <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  state.errors._data.errors && state.errors._data.errors.phone &&
                  state.errors._data.errors.phone[0] }}</div>
              </div>
              <div>
                <div class="lg:flex block duration-300">
                ...
                <input
                  class="lg:w-[340px] w-full bg-white py-2 px-3 rounded-md border-2 border-gray-300 outline-none focus:border-[#003568] focus:text-[#004e94] mt-1"
                  :class="{ 'border-red-500': state.errors && state.errors._data && state.errors._data.errors && state.errors._data.errors.address }"
                  type="text" v-model="state.user.address" />
                <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  state.errors._data.errors && state.errors._data.errors.address &&
                  state.errors._data.errors.address[0] }}</div>
              </div>
            </section>
          </section>
          ...
          <section class="">
            <section class="mb-3 flex lg:gap-0 gap-3 justify-between">
              <div>
                ...
                <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  state.errors._data.errors && state.errors._data.errors.username &&
                  state.errors._data.errors.username[0] }}</div>
              </div>
              <div>
                <div class="lg:flex block duration-300">
                ...
                <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  state.errors._data.errors && state.errors._data.errors.email &&
                  state.errors._data.errors.email[0] }}</div>
              </div>
            </section>
            ...
            <section class="mb-3 flex lg:gap-0 gap-3 justify-between">
              ...
              <div>
                ...
                <div class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  state.errors._data.errors && state.errors._data.errors.password &&
                  state.errors._data.errors.password[0] }}</div>
              </div>
