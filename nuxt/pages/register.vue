            ...
            <section class="mb-3">
              ...
              <section class="flex lg:gap-0 gap-2 justify-between mt-1">
                <div class="lg:w-[288px]">
                  ...
                  <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                    state.errors._data.errors && state.errors._data.errors.first_name &&
                    state.errors._data.errors.first_name[0] }}</span>
                </div>
                <div class="lg:w-[288px]">
                  ...
                  <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                    ...
                    state.errors._data.errors.last_name[0] }}</span>
                </div>
                <div class="">
                  ...
                  <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                    ...
                    state.errors._data.errors.middle_initial[0] }}</span>
                </div>
              </section>
            </section>
            ...
            <section class="mb-3 flex lg:gap-0 gap-3 justify-between">
              <div>
                ...
                <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  ...
                  state.errors._data.errors.birth_date[0] }}</span>
              </div>
              <div class="lg:w-full w-auto">
                ...
                <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  ...
                  state.errors._data.errors.gender[0] }}</span>
              </div>
            </section>
            ...
            <section class="mb-3 flex lg:gap-0 gap-3 justify-between">
              <div>
                ...
                <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  ...
                  state.errors._data.errors.phone[0] }}</span>
              </div>
              <div>
                <div class="lg:flex block duration-300">
                ...
                <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  ...
                  state.errors._data.errors.address[0] }}</span>
              </div>
            </section>
          </section>
            ...
            <section class="mb-3 flex lg:gap-0 gap-3 justify-between">
              <div>
                ...
                <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  ...
                  state.errors._data.errors.username[0] }}</span>
              </div>
              <div>
                <div class="lg:flex block duration-300">
                ...
                <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  ...
                  state.errors._data.errors.email[0] }}</span>
              </div>
            </section>
            ...
            <section class="mb-3 flex lg:gap-0 gap-3 justify-between">
              ...
              <div>
                ...
                <span class="text-red-500 text-sm font-semibold tracking-wide">{{ state.errors && state.errors._data &&
                  ...
                  state.errors._data.errors.password[0] }}</span>
              </div>
